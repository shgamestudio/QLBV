    ...
    public partial class ThanhToanHoaDon : Form
    {
        ...
        private void ThanhToanHoaDon_Load(object sender, EventArgs e)
        {
            ...
            if (chitiet.Rows.Count > 0)
            {
                ...
                this.label_mahl.Text = busVechuyenbay.TimTenHL(row["MAHL"].ToString());
                this.label_manv.Text = row["id_Nhan_Vien"].ToString();
        ...
        private void printDocument_Hoa_don_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
           ...
           // string _mave = "Mã vé: "+ label_maVe.Text;
            ...
            e.Graphics.DrawString("Giá tiền: " + label_gia.Text + " VNĐ", new Font("Times New Roman", 15, FontStyle.Regular), new SolidBrush(Color.Black), new Point(200, 340 + space_offset)); space_offset += 30;
            e.Graphics.DrawString("Loại hành lí: " + label_mahl.Text , new Font("Times New Roman", 15, FontStyle.Regular), new SolidBrush(Color.Black), new Point(200, 340 + space_offset)); space_offset += 30;
            e.Graphics.DrawString("Mã nhân viên bán vé: " + label_manv.Text, new Font("Times New Roman", 15, FontStyle.Regular), new SolidBrush(Color.Black), new Point(200, 340 + space_offset)); space_offset += 55;
            ...
            // Create rectangle.
            Rectangle rect = new Rectangle(20, 20, 811, 1060); //1058
            Rectangle rect_hk = new Rectangle(170, 280, 510, 335);
            Rectangle rect_ve = new Rectangle(170, k_offset-20, 510, 740); //692
