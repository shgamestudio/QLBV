...
namespace QLBVMB.DTO
{
    class Vechuyenbay
    {
        ...
        public Vechuyenbay(string maVe, string maKhachHang, string maChuyenBay, string maHangVe,  decimal giaTien, DateTime ngayGioGD, DateTime ngayHuy, string loaiVe, string maHL, string maNV)
        {
            this.mave = maVe;
